        ...
        <Actions
          ...
          actions={[
            ...
            },
            {
              content: (
                <Link href="/">
                  <a className="logo">{props.breweryName}</a>
                </Link>
              ),
            },
          ]}
          ...
          actions={[
            {
              content: (
                <a
                  className="left"
                  href={`https://github.com/overtheairbrew/homebrew`}
                  target="_blank"
                  rel="noreferrer"
                >
                  <GithubLogo height="20" width="20" viewBox="0,0,256,249">
                    <g>
                      <path
            ...
            },
            {
              content: (
                ...
                >
                  <User
                    image="url('/OTA_Logo_SocialCircle.svg')"
                    name="Over The Air Brew"
                    title="v1.0.0"
                    size="Medium"
                  />
                </ContextMenu>
